...
import profilePic1 from '../../assets/images/profilePic1.avif'
import profilePic2 from '../../assets/images/profilePic2.avif'
        ...
        <div className={styles['section-container']}>
          ...
          <div className={styles['who-container']}>
            {/* <div className={styles['team-member']}>
              <div>
                <div className={styles['profile-pic']}><img src={profilePic1} /></div>
                <h3>Ma. Cristina M. Pasague</h3>
                <h4><i>CEO & Founder</i></h4>
                <p className={styles['description']}>Cristina is a visionary leader with over 15 years of experience in the tech industry, pioneering sustainable solutions and mentoring young entrepreneurs worldwide.</p>
                <div className={styles['br']}></div>
              </div>
              <div className={styles['profile-details']}>
                <span>Education: </span><p>MBA from Harvard Business School</p>
                <span>Email: </span><p>cristina@example.com</p>
                <span>Address: </span><p>123 CleanHub Street, Duma City, PH</p>
                <span>Company: </span><p>Example Corporation</p>
              </div>
            </div> */}
            {/* <div className={styles['team-member']}>
              <div className={styles['profile-pic']}><img src={profilePic2} /></div>
              <h3>Ma. Cristina M. Pasague</h3>
              <h4><i>CTO</i></h4>
              <p className={styles['description']}>Cristina is a technology expert with a deep background in AI. She has contributed to several open-source projects and holds multiple patents in cybersecurity.</p>
              <div className={styles['br']}></div>
              <div className={styles['profile-details']}>
                <span>Education: </span><p>Ph.D. in Computer Science, MIT</p>
                <span>Email: </span><p>deisaki@example.com</p>
                <span>Address: </span><p>123 CleanHub Street, Duma City, PH</p>
                <span>Company: </span><p>Example Corporation</p>
              </div>
            </div> */}
            <div className={styles['team-member']}>
              ...
              <div className={styles['profile-details']}>
                ...
                <span>Address: </span><p>123 CleanHub Street, Dumaguete City, PH</p>
                <span>Company: </span><p>Example Corporation</p>
              </div>
            </div>
          </div>
